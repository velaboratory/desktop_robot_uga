...
namespace RuntimeGizmos
{
	...
	{
        public float myScale = 0.01f; //andrew
        public bool manualObjectSelection;
        public bool transformTypeIsAll;
		...
		void Update()
		{
            ...
            //Andrew. enforce all gizmos
            if (transformTypeIsAll)
            {
		...
		void OnPostRender()
		{
            ...
            //Andrew Disabling scaling here. Ensures only the move is implemented
            ...
            TransformType moveOrScaleType = TransformType.Move;
        ...
        {
           // Debug.Log("Making " + target.gameObject.name + " the current object");
            ClearAndAddTarget(target);
        }
